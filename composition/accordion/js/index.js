...
class ToggleAllSection extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <section className={this.state.open ? "section open" : "section"}>
        ...
        <h3 className="sectionhead" onClick={this.toggleSection}>
          {this.props.title}
        </h3>
...
ReactDOM.render(
  <Accordion title="React">
    <ToggleAllSection title="Компоненты">
    ...
    <ToggleAllSection title="Выучил раз, используй везде!">
    ...
    <ToggleAllSection title="Использование JSX">
